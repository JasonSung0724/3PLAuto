...
import math
TestEnv = 'dev'
WMStoken = 'eyJhbGciOiJSUzI1NiJ9..LOlKkasewB5QmdkLfMu6jqwOEPcSPT85cGADDW7sdaWr4uWZtIUO1zEzVgiuWk3pV_3MfKuJbWMO9tgLnfFeCViQH6QNZ88ieXAywU_KxnWSO7ZKbtN-OAbb6EcNhMvjOuySoCjjvqkpcR6vysi49EwIU-uzDjifN5h6l8gacEHtaGKZ7QDo-ARUdBj0-2d-bfi_GGOi4CDJA8dVffjiNhZpOZpSt6rtiG-RERD8hmgXszo-KEohajRMvgHHBYgL7vMIi4_DwClXO5Ds0JfNX0_12QCWySOCo7N1ayBCxOHUV9T4NfyC725ZXIi8Q7QE9MLJJzOe2cMhMhzXvyZ7Gg'
if WMStoken == "" :
    ...
    if TaskNoResponse['resultStatus'] == "SUCCESS" :
        ...
        for task , batchid in TaskDict.items() :
            ...
            try:
                ...
                print(f"Dirty data , have multiple batchid with same compartment {batchid[0]}")
                
                return
            for batch in batchid :
                Compartment = SKUdict[batch]['compartment']
                if Compartment == "A" : CellsCode = 1 
                elif Compartment == "B" : CellsCode = 2
                elif Compartment == "C" : CellsCode = 3
                elif Compartment == "D" : CellsCode = 4
            ...
            APIheaders = {"Content-Type" : "application/json"}
            M5108Response = requests.post(M5108URL,data=M5108Body,headers=APIheaders).json()
            print(M5108Body)
            print(M5108Response)
        return True
    else:
...
def __WeigthCheck__(BookingNumber):
    ...
    if TaskNoResponse['resultStatus'] == "SUCCESS" :
        ...
        for task in TaskList :
            ...
            CorrectWeigth = float((task['weightUpperLimit'] + task['weightLowerLimit'])/2)
            ...
            APIheaders = {"Content-Type" : "application/json"}
            M5112Response = requests.post(M5112URL,data=M5112Body,headers=APIheaders).json()
            print(M5112Body)
            print(M5112Response)
